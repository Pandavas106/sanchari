...
const features = [
  {
    ...
    description: "Our advanced AI analyzes millions of data points to create your perfect trip",
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              {['Features', 'Destinations', 'About', 'Contact'].map((item, index) => (
                <motion.button 
                  key={item}
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  ...
                  >
                    ...
                    >
                      <motion.div
                        className={`absolute inset-0 ${isDark ? 'bg-yellow-400' : 'bg-blue-600'}`}
                        initial={{ y: '100%' }}
                        whileHover={{ y: 0 }}
                        transition={{ duration: 0.3 }}
                      />
            ...
            {features.map((feature, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`p-8 rounded-2xl ${isDark ? 'bg-navy/50' : 'bg-white/50'} backdrop-blur-sm text-center group cursor-pointer`}
                >
                  <motion.div
                  ...
                  <p className={`${isDark ? 'text-gray-300' : 'text-gray-600'} group-hover:text-opacity-80 transition-all`}>
                    {feature.description}
                  </p>
                </motion.div>
              )
